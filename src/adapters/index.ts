...
import { readSymbols } from './symbolAdapter'
...
export const writeEntity = async (
  ...
  switch (entity.kind) {
    ...
    case 'hook':
      ...
      return
    case 'permission':
      await writePermission(ctx.loc, entity, nextValue)
      return
    case 'mcp':
...
export const createEntity = async (
  ...
  switch (kind) {
    ...
    case 'hook':
      ...
      return
    case 'permission':
      await writePermission(ctx.loc, null, value)
      return
    case 'mcp':
...
export const deleteEntity = async (
  ...
  switch (entity.kind) {
    ...
    case 'hook':
      ...
      return
    case 'permission':
      await deletePermission(ctx.loc, entity)
      return
    case 'mcp':
